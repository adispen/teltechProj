$(function() {
    ...
    // Initialize varibles
    var $window = $(window);
    var $page = top.location.pathname;
    var $usernameInput = $('.usernameInput'); // Input for username
    if ($page === '/'){
        $emailInput = $('.emailInput'); // Input for email if on main page
    ...
    // When a user logs in from the main page, log their email too
    socket.on('user email', function(data) {
        log(data.username + '\'s email: ' + data.email);
    });
